...
if ($marquee_type  === 'productV2') {
	$marquee_image = '/wp-content/uploads/2020/08/product-hero-v2-adj.png';
}
...
// 'laptopWoman', 'runningMan', 'sofaCouple' are css-only.
...
<script>
	...
	} )( window, document, 'script', 'dataLayer', 'GTM-KZF4FNH' );

</script>
<!-- End Google Tag Manager -->
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KZF4FNH" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<div id="top" class="site-container" id="top">
	<ul class="genesis-skip-link">
		<li><a href="#genesis-mobile-nav-primary" class="screen-reader-shortcut"> Skip to primary navigation</a></li>
			...
			<div class="wrap">
				<div class="title-area" itemscope="itemscope" itemtype="http://schema.org/Organization">
					...
					if ($field['branded'] === true) {
						...
						echo '<img src="/wp-content/uploads/2023/01/IDX-ZF-Logo_preferred.png" class="custom-logo" alt="MyIDCare">';
						echo '</a>';
					}
				...
				<?php include('idx-language-switcher.php'); ?>
					...
					<div class="wrap">
						<ul id="menu-header-menu" class="menu genesis-nav-menu menu-primary js-superfish sf-js-enabled sf-arrows">
							...
							<?php if ($field['display_additional_resources'] === true) :
								...
								echo '<a id="show-additional-resources-anchor"  href="#additional-resources">Additional Resources</a> </li>';
		...
		<div class="site-inner">
			<main class="content" id="genesis-content">
				<div id="marquee" class="front-page-widget <?php echo $marquee_type; ?> front-page-1 menu-trigger" data-background="<?php echo $marquee_background; ?>">
					<?php if (in_array($marquee_type, array('lifestyle', 'laptopWoman', 'runningMan', 'sofaCouple'))) : ?>
				...
				<?php if ($field['display_press_release'] === true) : ?>
					...
					<div id="press-release" class="front-page-widget front-page-0">
						<div class="wrap">
							<?php if (!isset($field['hide_press_release_heading']) || $field['hide_press_release_heading'] !== true) : ?>
								<h2><?= (!empty($field['press_release_heading']) ? $field['press_release_heading'] : 'Notice of Data Breach') ?></h2>
							<?php endif; ?>
